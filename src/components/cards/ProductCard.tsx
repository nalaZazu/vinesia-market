  ...
  return (
    <div>
      <div>
        ...
        <h4 className=" text-black text-base font-semibold  tracking-tight w-[88%]	">
        ...
        <span>
          <p className="font-semibold   text-black text-xxs  tracking-wide">Owner</p>
          <span className="inline-flex items-center rounded-md bg-[#842029] px-2 py-1   font-medium text-white ring-1 ring-inset ring-[#842029]      text-xxs  tracking-wide">
            Vinesia
          </span>
        </span>
        ...
        <span className="flex  text-black text-xxs font-medium  tracking-wide">
          <p>50 bottles</p>
          <p className=" ml-3 text-[#959596]  text-xxs font-medium  tracking-wide">50 remaining </p>
        </span>
      </div>
    </div>
  );
