            ...
            <div className="bg-white py-1">
              <div>
                ...
                <div className="grid lg:grid-cols-3 py-3 gap-4 ps-3">
                  ...
                  <div className="col-span-2 border-s ps-3">
                    <span className=" font-normal text-base text-spacegray">
                      Reso consciously breaks with traditional reading habits
                      and offers viewers a completely new image of typography.
                      He no longer arranges the letters classically from left to
                      right and one behind the other, but allows them to merge
                      into constructs of form in order to provide viewers with
                ...
                <div className="flex justify-end items-center lg:gap-16 md:gap-8 gap-8 py-4 text-sm px-5 text-spacegray">
                  ...
                  <button
                    type="button"
                    className="text-spacegray bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-base px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-800 mr-2"
                  >
                    See More
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="flex justify-between items-center pt-4 py-1 px-5">
                  <div className=" uppercase items-center flex gap-3 ps-3">
                    <p className="text-xs">Vinesia price</p>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke-width="1.5"
                      stroke="currentColor"
                      className="w-6 h-6 text-spacegray"
                    >
                      <path
                        stroke-linecap="round"
                        stroke-linejoin="round"
