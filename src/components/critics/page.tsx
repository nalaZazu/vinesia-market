      ...
      <div className=" flex">
        ...
        <div className="col-span-2 ">
          ...
          <div className="flex">
            ...
            <ul className=" w-2/3  text-base font-medium   tracking-tight">
              <li>
        ...
        <div className=" ">
          ...
          <div className="flex flex-col ">
            <span className="font-semibold  text-secondary text-xxl  tracking-tight">5/5</span>
            <span className="text-base font-medium mt-5   text-secondary  tracking-tigh">by Robert Parker</span>
          </div>
          <span>
